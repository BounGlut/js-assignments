...
function getRectangleString(width, height) {
	...
	return '┌'+str.repeat(width-2)+'┐'+'\n'+str2.repeat(height-2)+'└'+str.repeat(width-2)+'┘'+'\n';
}
...
function encodeToRot13(str) {
	return str.replace(/([A-Za-z])/g, rep);
}
function rep(march){
...
function getCardId(value) {
    var val = 'A234567891JQK';
	var mas = '♣♦♥♠';
	var i = 0;
	if(value[0] =='1')
		return i = 9 + mas.indexOf(value[2]) * 13;
	else
		return i=val.indexOf(value[0]) + mas.indexOf(value[1]) * 13;		
}
